...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    if(cachedwolf) {
      return Promise.resolve(onLoadItem(cachedwolf.clone()));
    }

    let mtl = require('./Wolf_obj.mtl');
    let obj = require('./Wolf_obj.obj');
    let mtl1 = require('./Wolf_One_obj.mtl');
    let obj1 = require('./Wolf_One_obj.obj');

    return loadObjWithMaterial(mtl, obj, mtl1, obj1, '')
      .then(object => {
        cachedwolf = object;
        return onLoadItem(cachedwolf.clone())
      })
  }
